...
//		int max_nondef_actions
		...
		System.out.println("This is one of the usage of KeySet Operation!!!!");
		...
		//This part is addition to the new State.java.
...
//		System.out.println("This is Second usage of KeySet Operation!!!!");
//		// Now add in constants to superclasses as well
//		for (Map.Entry<TYPE_NAME,ArrayList<LCONST>> e : _hmObject2Consts.entrySet()) {
//			TYPE_NAME tname = e.getKey();
//			// Add superclass constants for each tname
//			TYPE_NAME cur_tname = tname;
//			while (true) {
//				// Terminate loop if enum or no superclass
...
//		}
		...
		if(nf_nonfluents !=null)
			setPVariables(_nonfluents, nf_nonfluents);
		if(i_nonfluents !=null)
	...
	public boolean checkActionConstraints(ArrayList<PVAR_INST_DEF> actions)
			throws EvalException {
